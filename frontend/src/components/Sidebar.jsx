  ...
  return (
    <div className="w-64 h-screen bg-gray-100">
      <Link
        ...
        className={`flex items-center p-4 mt-2 bg-gray-100 hover:bg-yellow-200 focus:bg-yellow-200 ${
          activeMenu === "dashboard" ? "bg-yellow-200" : ""
        }`}
      >
        <svg
        ...
        <span className="ml-4 text-lg text-gray-800">Home</span>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
      ...
      <Link
        ...
        className={`flex items-center p-4 mt-2 bg-gray-100 hover:bg-yellow-200 focus:bg-yellow-200 ${
          activeMenu === "roles" ? "bg-yellow-200" : ""
        }`}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <span className="ml-4 text-lg text-gray-800">Roles</span>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
      ...
      <Link
        ...
        className={`flex items-center p-4 mt-2 bg-gray-100 hover:bg-yellow-200 focus:bg-yellow-200 ${
          activeMenu === "users" ? "bg-yellow-200" : ""
        }`}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <span className="ml-4 text-lg text-gray-800">Users</span>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
